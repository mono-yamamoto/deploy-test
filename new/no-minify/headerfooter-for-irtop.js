...
(function (global, factory) {
  ...
  */
  ...
  if (uas.match(/MSIE/i) || uas.match(/Trident/)) {
   isIE = true;
  }
  ...
  */
  document.addEventListener('DOMContentLoaded', function () {
   ...
   $main_main_container = $('#main main .container');
  ...
  */
  function pageTop() {
   ...
   function pageTopScroll() {
    ...
    var scrollPos = window.innerHeight + (document.documentElement.scrollTop || document.body.scrollTop);
  ...
  */
  function headerFooter() {
   //var $body = $('body');
   $header = $("header");
   var $header_header__nav = $(".header .header__nav");
   var $header_header__nav_ul_li = $(".header .header__nav > ul > li"); 
   var $header__function__search = $(".header__function__search");
   var $header__function__search__form = $(".header__function__search__form");
   var $header__function__menu_span_img = $('.header__function__menu button img');
   var $closeSecondWrap_span = $(".header__nav > ul > li .second-wrap .close-second-wrap span");
   //$contentWrapper = $('.content-wrapper');
   ...
   (function () {
    ...
    $(".header__function__menu").on("click", function () {
     ...
     if ($header_header__nav.is(":hidden")) {
      ...
      current_scrollY = document.documentElement.scrollTop || document.body.scrollTop;
      $contentWrapper.css({
       position: 'fixed',
       width: '100%',
   ...
   (function () {
    ...
    function pcDroppdown() {
     ...
     function secondWrapOpen(obj) {
      ...
      $header__function__search.removeClass("is-open"); //search remove
    ...
    $(".header__nav >ul >li >a").keydown(function (e) {
     if (e.which === 9) {
      if (e.shiftKey) {
       ...
       //$(this).parent().removeClass("is-op.header__function__search >aen");
      }
     }
    });
  ...
  function lHeaders() {
    ...
    //if ($lheader.length) {
      ...
      window.addEventListener(resizeEvent, function (event) {
        if(getBreakPointIndex()) {
          if($(".overlay").length){
            overlayRemove();
            hnOpen = false;
          }
          if ($(".l-header__block__search").hasClass("is-open")) {
            $(".l-header__block__search").removeClass("is-open");
          }
...
function spMenuBackground() {
  ...
  $lheader.css(lh_fixedClearCss);

  if (bp === 0 && hnOpen && $('.overlay').length === 0) { //背景がない時

    savewTop = $window.scrollTop();
...
function overlayRemove() {
  var $overlay = $(".overlay");
  if ($overlay.length) {
    $lheader__block__smMenuBtn.removeClass("is-open");
    $lheader__navigation.removeClass("is-open");
...
function setFixedSubHeader() {
  ...
  /*
	if(!localnavigation_Scroll){
		...
		$lheader.on('transitionend', function () {
			controll(bpi);
			$lheader.off('transitionend', function () {
				controll(bpi);
			});
		});
  ...
  */
	...
	$window.on('break', function (e, bpi) {
    controll(bpi);
    /*
		if(!localnavigation_Scroll){
			controll(bpi);
    ...
    */
	...
	function controll(bpi) {
		...
		var headerTtlH = $lheader__block.outerHeight()+1;
        ...
        console.log(sevents);
			...
			if (!hnOpen && (winScrollY < document.body.clientHeight - window.innerHeight)) {
				...
				if (winScrollY > headerY) {
					...
					$contentWrapper.css('margin-top', headerWrapH);
					if (bpi === 0) {
