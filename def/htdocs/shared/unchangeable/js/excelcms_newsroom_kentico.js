/* ==================================
	...
	2019-02-28  #6548-#10 【Kentico移行PJ】Newsoomのjsonの改修
	2019-03-11  #6548-#15 【Kentico移行PJ】Newsoomのjsonの改修
	2019-03-15  #6548-#15 【Kentico移行PJ】Newsoomのjsonの改修 （post -> get)
	2019-12-20  #8326 ニュースルーム年度更新確認
===================================== */
...
var defaultImgFolder = "/newsroom/img/"
var localFolder = "/";
for (var r in locArr){
	...
	function outputAdd(x,tObj , obj, sObj) {
		...
		if(tObj.Thumbnail.charAt(0) === '/' || tObj.Thumbnail.search('http') !==-1) {
			...
			if(tObj.Thumbnail !=='') {
				...
				//localFolder + tempDate[0] + '/img/' + tObj.Thumbnail;
				if(tObj.Thumbnail.search('default_') === 0){	//2019-03-11 #6548-#15
					obj[x].thumbnail = releaseDomain + defaultImgFolder + tObj.Thumbnail;
				} else {
					obj[x].thumbnail = releaseDomain + localFolder + tempDate[0] + '/img/' + tObj.Thumbnail;
				}
		...
		while(tObj['Category-' + stCnt]){
			...
			if(thumbDef){
				...
				//2019-02-28 #6548-#10
				obj[x].thumbnail = releaseDomain + defaultImgFolder + 'default_thumbnail_' + stta + '_' + defaultCnt[stta] + '.jpg';
